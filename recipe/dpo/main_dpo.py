...
class TaskRunner:
    def run(self, config):
        ...
        if config.actor_rollout_ref.actor.strategy in {"fsdp", "fsdp2"}:
            ...
            from recipe.dpo.fsdp_workers import SPINRolloutRefWorker
        ...
        from recipe.dpo.dpo_trainer import ResourcePoolManager, Role
        ...
        if config.reward_model.enable:
            if config.reward_model.strategy in {"fsdp", "fsdp2"}:
                from recipe.dpo.fsdp_workers import RewardModelWorker
